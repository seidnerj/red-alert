...
from red_alert.integrations.outputs.unifi.led_controller import UnifiLedController, _wrap_request_with_2fa, rgb_to_hex
...
class TestConnectAiounifi:
    ...
    async def test_connect_creates_session_if_not_provided(self):
        ...
        with (
            ...
            patch('red_alert.integrations.outputs.unifi.led_controller.aiohttp.ClientSession') as mock_session_cls,
        ):
