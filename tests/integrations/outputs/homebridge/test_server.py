...
from red_alert.integrations.outputs.homebridge.server import AlertMonitor
...
class TestHTTPEndpoints:
    ...
    def app(self):
        ...
        from red_alert.integrations.outputs.homebridge.server import handle_contact, handle_city_contact, handle_health, handle_state, handle_status
