...
from red_alert.integrations.outputs.homepod.server import (
    DeviceAction,
    HomepodAlertMonitor,
...
class TestHomepodAlertMonitor:
    def _make_monitor(self, device_actions=None, areas_of_interest=None, hold_seconds=NO_HOLD):
    ...
    async def test_multiple_devices(self):
        ...
        state_tracker = AlertStateTracker(hold_seconds=NO_HOLD)
