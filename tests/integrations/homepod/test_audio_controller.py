...
class TestConnect:
    @pytest.mark.asyncio
    @patch('red_alert.integrations.homepod.audio_controller._PROTOCOL_MAP', {'airplay': 'FakeProtocol.AirPlay'})
    @patch('red_alert.integrations.homepod.audio_controller._pyatv')
    ...
    @pytest.mark.asyncio
    @patch('red_alert.integrations.homepod.audio_controller._pyatv', None)
    ...
    @pytest.mark.asyncio
    @patch('red_alert.integrations.homepod.audio_controller._PROTOCOL_MAP', {})
    @patch('red_alert.integrations.homepod.audio_controller._pyatv')
